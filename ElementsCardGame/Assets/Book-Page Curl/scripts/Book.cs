...
public class Book : MonoBehaviour {
    ...
    void Start() {
        ...
        Vector3 globalsb = BookPanel.transform.position + new Vector3(0, -pageHeight * 0.5f);
        sb = transformPoint(globalsb);
        
		Vector3 globalebr = BookPanel.transform.position + new Vector3(pageWidth, -pageHeight * 0.5f);
        ebr = transformPoint(globalebr);
        
		Vector3 globalebl = BookPanel.transform.position + new Vector3(-pageWidth, -pageHeight * 0.5f);
        ebl = transformPoint(globalebl);

		Vector3 globalst = BookPanel.transform.position + new Vector3(0, pageHeight * 0.5f);
    ...
    public void UpdateBook() {
        f= Vector3.Lerp(f, transformPoint( Input.mousePosition), Time.deltaTime * 15);
